...
/**
 * @file
 * Default theme implementation to display a list of youwo topics.
 *
 * Available variables:
 * - $header: The table header. This is pre-generated with click-sorting
 *   information. If you need to change this, see
 *   template_preprocess_youwo_topic_list().
 * - $pager: The pager to display beneath the table.
 * - $topics: An array of topics to be displayed.
 * - $topic_id: Numeric id for the current youwo topic.
 *
 ...
 *
 * @see template_preprocess_youwo_topic_list()
 * @see theme_youwo_topic_list()
 */
?>
<table id="youwo-topic-<?php print $topic_id; ?>">
  <thead>
  ...
  <?php foreach ($topics as $topic): ?>
    ...
    <?php else: ?>
	  ...
	  <td class="request-status"><?php print $topic->request_status; ?></td>
    <?php endif; ?>
    </tr>
  <?php endforeach; ?>
  </tbody>
